...
-- Exported by dibaaminshahidi at 18-05-1402 1:57 PM.
...
-- Inserting 275 rows into Artist
-- Insert batch #1
...
-- Inserting 8 rows into Employee
-- Insert batch #1
...
-- Inserting 59 rows into Customer
-- Insert batch #1
...
-- Inserting 412 rows into Invoice
-- Insert batch #1
...
-- Inserting 5 rows into MediaType
-- Insert batch #1
...
-- Inserting 3503 rows into Track
-- Insert batch #1
...
-- Inserting 2240 rows into InvoiceLine
-- Insert batch #1
...
-- END TABLE InvoiceLine

-- BEGIN TABLE Playlist
...
-- Inserting 18 rows into Playlist
-- Insert batch #1
...
-- Inserting 8715 rows into PlaylistTrack
-- Insert batch #1
